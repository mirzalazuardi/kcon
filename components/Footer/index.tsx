      ...
      >
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Inovasi Teknologi untuk Bisnis yang Lebih Baik
                </p>
                ...
                {/* ig */}
                  <a
                    href="https://www.instagram.com/kal_connect"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  <svg
                  ...
                  <a
                    href="https://www.youtube.com/@DevEdVenture"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                  ...
                  {/* linkedin */}
                  <a
                    href="https://www.linkedin.com/in/mirzalazuardi"
                    aria-label="social-link"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  ...
                  <ul>
                  <li>
                  <a href="mailto:hi@kalconnect.com" className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">hi@kalconnect.com</a>
                  </li>
                  <li>
                  <a href="tel:+6281573088881" className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">Call me</a>
                  </li>
                  </ul>
                {/*
                  <ul>
          ...
          <div className="py-8">
            ...
            CV Karya Aruna Lazuardi | KalConnect © 2024. All Rights Reserved.
            </p>
            <p className="text-center text-base text-body-color dark:text-white">
